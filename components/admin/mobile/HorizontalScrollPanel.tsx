          ...
          >
            {options.map((option) => (
              <button
                ...
                className={`flex-shrink-0 px-3.5 py-2 rounded-lg transition-all duration-200 flex items-center gap-1.5 text-xs font-medium whitespace-nowrap active:scale-95 ${
