...
import VersionNotesManagerMobile from "@/components/admin/VersionNotesManagerMobile";
import RecycleBin from "@/components/admin/RecycleBin";
import RecycleBinMobile from "@/components/admin/RecycleBinMobile";
...
export default function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "dashboard" | "version" | "projects" | "settings" | "recycle"
  >("dashboard");
  ...
  // Desktop menu items (without Recycle Bin - only mobile)
      ...
      <main className="flex-1 flex flex-col lg:flex-row overflow-hidden min-h-0">
        ...
        >
          ...
          <div className="shrink-0 px-3 pb-2">
            <div className="bg-gray-50 rounded-md px-3 py-2 border border-gray-200">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-medium text-gray-600">Version</span>
                <div className="flex items-center gap-1">
                  <div className="w-1 h-1 rounded-full bg-green-500 animate-pulse"></div>
                  <span className="text-[11px] font-semibold text-gray-900">v1.0.0</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="shrink-0 px-3 pb-3 border-t border-gray-100 pt-2">
            <div className="text-center space-y-1.5">
              ...
              <p className="text-[9px] text-gray-500">© {new Date().getFullYear()} Portfolio</p>
            </div>
          </div>
        </aside>
        ...
        <aside className="hidden lg:block w-48 border-r border-gray-200 p-4 bg-white overflow-y-auto">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-xs font-semibold uppercase tracking-wide text-gray-600">Menu</h3>
          </div>
          <nav className="space-y-1">
